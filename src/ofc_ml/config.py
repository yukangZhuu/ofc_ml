...
TRAINING_CONFIG = {
    ...
    "FINETUNE_MODEL_PATH": PROJECT_ROOT / "models" / "finetuned_model.pt",
...
FINETUNE_MODEL_PATH = TRAINING_CONFIG.get("FINETUNE_MODEL_PATH", PROJECT_ROOT / "models" / "finetuned_model.pt")
